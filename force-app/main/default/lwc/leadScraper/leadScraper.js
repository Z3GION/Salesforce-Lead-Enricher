...
import fetchNews from '@salesforce/apex/LeadScraperController.fetchNews';
import createLead from '@salesforce/apex/LeadScraperController.createLead';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class LeadScraper extends LightningElement {
    @track searchTerm = '';
    @track results = [];
